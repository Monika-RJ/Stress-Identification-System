...
data = pd.read_csv('/content/drive/MyDrive/TAMIL_TRAINING_DATA.csv')
...
test_text = pd.read_csv("/content/drive/MyDrive/TAMIL_TEST.csv")
...
for true_label, pred_label in zip(y_test[:1020], test_predictions[:1020]):
...
predicted_labels = test_predictions[:1020]
results_df = pd.DataFrame({
    'Test Text': test_text['Text data'],
    'Predicted_Labels': predicted_labels})

# Save the results to a CSV file
results_df.to_csv('/content/drive/MyDrive/Tamil_SVC_01.tsv', index=False)

print("\nResults saved to Tamil_SVC_01.csv")
...
# Save the results to a CSV file
results_df.to_csv('/content/drive/MyDrive/Tamil_RF_01.tsv', index=False)

print("\nResults saved to Tamil_RF_01.csv")
...
# Save the results to a CSV file
results_df.to_csv('/content/drive/MyDrive/Tamil_NB_01.tsv', index=False)

print("\nResults saved to Tamil_NB_01.csv")
